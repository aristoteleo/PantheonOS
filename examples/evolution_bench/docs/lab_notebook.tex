...
idea is injected into a trajectory, how a trajectory is digested into understanding, every
parameter with its default, and the benchmark results against three other methods on three tasks,
two models, and the AlphaEvolve suite (\S\ref{sec:results}).
\end{abstract}
