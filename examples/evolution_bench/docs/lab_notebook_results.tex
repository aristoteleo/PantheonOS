...
\begin{figure}[H]\centering
\includegraphics[width=\textwidth]{lab_notebook_figs/budget_llm_ahc039_flash.png}
\caption{AHC039, flash: best-so-far against cumulative LLM calls. LabNotebook's curve rises in
steps --- each step is a cycle whose best trajectory beat the champion --- and keeps rising past
300 calls where the other methods have flattened.}
\end{figure}
...
\begin{figure}[H]\centering
\includegraphics[width=\textwidth]{lab_notebook_figs/budget_llm_ahc039_pro.png}
\caption{AHC039, pro: best-so-far against cumulative LLM calls.}
\end{figure}

\subsection{Erd\H{o}s: the 0.381 floor, and two ways past it}

\begin{figure}[H]\centering
\includegraphics[width=\textwidth]{lab_notebook_figs/budget_llm_erdos_flash.png}
...
\begin{table}[H]\centering\small
\caption{Batch A: per-arm results in the papers' units, with the published values. Arms still
running are marked $^\circ$; a dash is an arm that had not started when the table was made.}
\label{tab:ae}
\begin{tabular}{@{}lrrrrr@{}}
\toprule
...
SimpleTES & 2.939573 & 2.933651$^\circ$ & 2.939573 & 2.937599 & 3.3 \\
LabNotebook & 2.939572$^\circ$ & 2.939573$^\circ$ & 2.939573 & 2.939573 & 2.5 \\
...
\midrule
HypothesisBandit & 1.51589 & 1.51589 & --- & 1.51589 & 2.7 \\
AgentMapElites & 1.51450 & 1.51273 & --- & 1.51362 & 3.8 \\
SimpleTES & \textbf{1.50941} & 1.51148 & 1.51248$^\circ$ & 1.51112 & 2.4 \\
LabNotebook & 1.51063 & 1.51267 & 1.50947$^\circ$ & \textbf{1.51093} & 2.0 \\
...
AgentMapElites & 0.9127 & 0.9086 & --- & 0.9107 & 3.9 \\
SimpleTES & 0.9101$^\circ$ & 0.9079 & 0.9139$^\circ$ & 0.9106 & 2.5 \\
\textbf{LabNotebook} & \textbf{0.9248} & 0.9099$^\circ$ & 0.9185 & \textbf{0.9177} & 1.9 \\
...
\caption{Batch A with every published bound drawn. Packing $n{=}32$: three arms sit on the record.
$C_1$: our best arms fall between the human record and AlphaEvolve v1, with the 2026 systems a
clear band above. $C_2$: above AlphaEvolve v1 and the human best, well below the 2026 band.}
\end{figure}
...
\item \textbf{AlphaEvolve suite.} Record on packing $n{=}32$; $C_2$ is LabNotebook's, $C_1$ a
  tie; both behind the 2026 systems by margins their extra compute explains.
