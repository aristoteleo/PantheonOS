...
comparable within this table, not with Table~\ref{tab:flash}. The three SimpleTES AHC039 arms are
still running ($^\circ$, lower bounds); s2 was restarted from scratch by a Modal re-run under the
pre-resume launcher and lost its first 197 calls.}
\label{tab:pro}
\begin{tabular}{@{}lrrrrr@{}}
\toprule
...
SimpleTES & 3610$^\circ$ & 3712$^\circ$ & 3501$^\circ$ & 3608 & 18.1 \\
...
other method (next best: MAP-Elites 3724); 3776 is the best score of both campaigns. Packing and Erd\H{o}s are ties within
...
\paragraph{Batch B (in progress).} Third autocorrelation inequality ($C_3$, upper bound, lower is
...
(record); $C(A)$ --- SimpleTES 1.1449. Table~\ref{tab:aeb} is a snapshot with most LabNotebook and
SimpleTES arms still running; the MAP-Elites $C_3$ value of 1.45363 would sit below the published
record and is awaiting re-verification.

\begin{table}[H]\centering\small
\caption{Batch B snapshot (2026-09-04 06:30 PDT). $^\circ$ = still running (lower bound); a dash is
an arm without data yet.}
\label{tab:aeb}
\begin{tabular}{@{}lrrrrr@{}}
\toprule
...
method & s0 & s1 & s2 & mean & tokens \\
\midrule
HypothesisBandit & 1.47688 & 1.72827 & 1.46265 & 1.55594 & 3.7 \\
AgentMapElites & 1.45363 & 3.15846 & 1.48264 & 2.03158 & 4.2 \\
SimpleTES & 1.46605 & 1.46347$^\circ$ & 1.47281 & 1.46744 & 3.2 \\
LabNotebook & 1.54943$^\circ$ & 1.48908$^\circ$ & 1.47280$^\circ$ & 1.50377 & 1.6 \\
\midrule
\multicolumn{6}{@{}l}{\textbf{sums vs differences} --- $C(A)$, higher is better} \\
\midrule
HypothesisBandit & 1.0787 & 1.0668 & 1.0598 & 1.0684 & 3.5 \\
AgentMapElites & 1.0598$^\circ$ & 1.0625 & --- & 1.0612 & 4.0 \\
SimpleTES & 1.0668$^\circ$ & 1.0677 & 1.0621$^\circ$ & 1.0655 & 2.7 \\
LabNotebook & 1.0668$^\circ$ & \textbf{1.0865} & 1.0598$^\circ$ & 1.0710 & 2.0 \\
\midrule
\multicolumn{6}{@{}l}{\textbf{Hadamard, order 29} --- $|\det|$ / reference, higher is better} \\
\midrule
HypothesisBandit & 0.4791$^\circ$ & 0.4378 & 0.5558 & 0.4909 & 3.4 \\
AgentMapElites & 0.1433 & 0.5037 & 0.1433 & 0.2634 & 4.0 \\
SimpleTES & 0.8596$^\circ$ & 0.5695$^\circ$ & 0.8066$^\circ$ & 0.7452 & 1.3 \\
LabNotebook & 0.5582$^\circ$ & 0.8596$^\circ$ & 0.4637$^\circ$ & 0.6272 & 1.7 \\
\bottomrule
\end{tabular}
\end{table}
...
\caption{Batch B snapshot. Hollow markers are arms still running.}
\end{figure}
...
SimpleTES & \$1.80{\scriptsize\,(3)} & \$0.29{\scriptsize\,(3)} & \$0.32{\scriptsize\,(3)} & --- & \$5.42{\scriptsize\,(3)} & \$5.97{\scriptsize\,(3)} \\
...
\$0.66/\$1.98), finished arms only, so the pro SimpleTES AHC039 cell is empty. LabNotebook is
...
\item \textbf{Limits of the evidence.} Three arms per cell; model sampling unseeded; the pro SimpleTES
