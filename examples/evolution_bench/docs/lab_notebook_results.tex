...
\begin{table}[H]\centering\small
\caption{Part 1 snapshot (2026-09-08 21:45 PDT): best per arm (s0 / s1 / s2) and mean. Dashes are
...
upstream, authors' defaults & 0.9120 & 0.9094 & --- & 0.9107 \\
\midrule
...
upstream, authors' defaults & 0.8554 & 0.7126 & --- & 0.7840 \\
\midrule
...
\begin{table}[H]\centering\small
\caption{Part 2 snapshot (2026-09-08 21:45 PDT). $^\circ$ = still running (best so far, a lower bound).
AHC039 arms are nine hours into $\sim$14; their bests are not yet informative.}
\label{tab:part2}
\begin{tabular}{@{}lrrrr@{}}
\toprule
\multicolumn{5}{@{}l}{\textbf{$C_2$} (higher is better)} \\
...
no notebook & 0.9017$^\circ$ & 0.9108 & 0.9251 & 0.9125 \\
no digest & 0.8824$^\circ$ & 0.9304 & 0.9273 & 0.9134 \\
\midrule
\multicolumn{5}{@{}l}{\textbf{sums vs differences} (higher is better)} \\
\midrule
LabNotebook (full) & 1.0668 & 1.0865 & 1.0621 & 1.0718 \\
no ideas & 1.0668 & 1.0754 & 1.0865 & 1.0762 \\
one long trajectory & 1.0827 & 1.0960$^\circ$ & 1.0744$^\circ$ & 1.0844 \\
no notebook & 1.0674$^\circ$ & 1.0662$^\circ$ & 1.0773$^\circ$ & 1.0703 \\
no digest & 1.0936$^\circ$ & 1.0674$^\circ$ & 1.0666$^\circ$ & 1.0759 \\
\midrule
\multicolumn{5}{@{}l}{\textbf{AHC039 block} (official points; all arms running)} \\
\midrule
LabNotebook (full) & 3698$^\circ$ & 3757$^\circ$ & 3727$^\circ$ & 3727 \\
our port & 3677$^\circ$ & 3524$^\circ$ & 3685$^\circ$ & 3629 \\
no ideas & 3179$^\circ$ & 3661$^\circ$ & --- & --- \\
one long trajectory & 3700$^\circ$ & 3722$^\circ$ & --- & --- \\
no notebook & 3708$^\circ$ & 3709$^\circ$ & 3737$^\circ$ & 3718 \\
no digest & 3702$^\circ$ & 3744$^\circ$ & 3675$^\circ$ & 3707 \\
\bottomrule
\end{tabular}
\end{table}
...
on sums vs differences it does not hurt. Removing the digest does not hurt C2 either --- two arms
finished above every full-method arm --- and the single long trajectory is strong on both. The
AHC039 block, where the effect to explain is largest, is nine hours in.}
\end{figure}
...
\begin{table}[H]\centering\small
\caption{Selector study snapshot (2026-09-08 21:45 PDT, all arms $\le 5$ h in). $^\circ$ = still running.}
\label{tab:sel}
\begin{tabular}{@{}lrrrr@{}}
\toprule
\multicolumn{5}{@{}l}{\textbf{$C_2$} (higher is better)} \\
...
$K{=}2$, $T{=}4$, balance & 0.9224$^\circ$ & 0.9329$^\circ$ & 0.9102$^\circ$ & 0.9219 \\
$K{=}2$, $T{=}4$, rpucg & 0.9154$^\circ$ & 0.9247$^\circ$ & 0.9267$^\circ$ & 0.9222 \\
$K{=}1$, $T{=}8$, balance & 0.9065$^\circ$ & 0.9163$^\circ$ & 0.9172$^\circ$ & 0.9133 \\
$K{=}1$, $T{=}8$, rpucg & 0.9066$^\circ$ & 0.9053$^\circ$ & --- & 0.9060 \\
port, rpucg & 0.9101 & 0.9079 & 0.9139 & 0.9106 \\
port, balance & 0.8780$^\circ$ & 0.9055$^\circ$ & --- & 0.8918 \\
\midrule
\multicolumn{5}{@{}l}{\textbf{sums vs differences} (higher is better)} \\
\midrule
LabNotebook $K{=}4$, $T{=}2$, balance (full) & 1.0668 & 1.0865 & 1.0621 & 1.0718 \\
$K{=}2$, $T{=}4$, balance & 1.0620$^\circ$ & 1.0598$^\circ$ & --- & 1.0609 \\
$K{=}2$, $T{=}4$, rpucg & 1.0598$^\circ$ & 1.0598$^\circ$ & --- & 1.0598 \\
$K{=}1$, $T{=}8$, balance & 1.0827 & 1.0960$^\circ$ & 1.0744$^\circ$ & 1.0844 \\
$K{=}1$, $T{=}8$, rpucg & 1.0598$^\circ$ & --- & --- & 1.0598 \\
port, rpucg & 1.0668 & 1.0677 & 1.0621 & 1.0655 \\
port, balance & 1.0667$^\circ$ & --- & --- & 1.0667 \\
\bottomrule
\end{tabular}
\end{table}
...
\caption{Selector study snapshot. Too early to separate the selectors; the $K{=}2$, $T{=}4$ arms
are already at or above the full method on C2 under both.}
\label{fig:sel}
\end{figure}
