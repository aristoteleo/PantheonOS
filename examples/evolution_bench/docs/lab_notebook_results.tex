...
\begin{table}[H]\centering\small
\caption{Ablations on hexagon-11 and Heilbronn convex-13 (snapshot 2026-09-15 14:10 PDT, 22 of 24 arms finished; $^\circ$ = the two hexagon one-long arms resumed after the walltime, best so far). Best per arm (s0 / s1 / s2) and mean; higher is better.}
\label{tab:ablc}
\begin{tabular}{@{}lrrrr@{}}
\toprule
...
one long trajectory & 0.9774$^\circ$ & --- & 0.9820 & 0.9797 \\
...
\caption{Ablations on hexagon-11 (left) and Heilbronn convex-13 (right). The pattern of the other tasks
repeats. Removing the ideas is the one change that hurts on both: hexagon-11 falls from 0.852 to
0.683 (one seed exactly at the port's 0.491), Heilbronn from 0.914 to 0.664, below even the port
...
hexagon-11 two seeds reach 0.98 and one produces no valid packing in 60 items; on Heilbronn its
mean (0.839) is below the full method and the port.}
\label{fig:ablc}
\end{figure}
