...
\item \textbf{AlphaEvolve suite.} Batch A: packing $n{=}32$ LabNotebook on the record 3/3, SimpleTES
  ...
  (0.914 vs 0.889, one arm at AlphaEvolve's value). Across nine tasks: LabNotebook ahead on four,
  SimpleTES on one, four ties --- and both far ahead of the two agent-based methods. All are behind
  the 2026 systems by margins their extra compute explains.
