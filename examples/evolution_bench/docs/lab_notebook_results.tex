...
\begin{table}[H]\centering\small
\caption{Part 1 snapshot (2026-09-09 08:30 PDT): best per arm (s0 / s1 / s2) and mean. Dashes are the five
engine arms still running (now on Sherlock, resumed from the engine's own checkpoints); the upstream
engine keeps no partial results.}
\label{tab:part1}
\begin{tabular}{@{}lrrrr@{}}
\toprule
...
upstream, authors' defaults & --- & 1.0668 & 1.0668 & 1.0668 \\
\midrule
...
upstream, port-mirror & --- & 0.8877 & 0.9163 & 0.9020 \\
...
\begin{table}[H]\centering\small
\caption{Part 2 snapshot (2026-09-09 08:30 PDT). $^\circ$ = still running (best so far, a lower bound). The
AHC039 arms are frozen at their Modal checkpoints (35--155 rows of $\sim$180) until the Sherlock
eval servers are up; the one finished arm is the upstream engine, seed 1.}
\label{tab:part2}
\begin{tabular}{@{}lrrrr@{}}
\toprule
\multicolumn{5}{@{}l}{\textbf{$C_2$} (higher is better)} \\
...
one long trajectory & 0.9112$^\circ$ & 0.9244 & 0.9172$^\circ$ & 0.9176 \\
...
one long trajectory & 1.0827 & 1.0960$^\circ$ & 1.0763$^\circ$ & 1.0850 \\
no notebook & 1.0674$^\circ$ & 1.0754 & 1.0927 & 1.0785 \\
no digest & 1.0936$^\circ$ & 1.0674 & 1.0668 & 1.0759 \\
\midrule
\multicolumn{5}{@{}l}{\textbf{AHC039 block} (official points)} \\
\midrule
...
no notebook & 3708$^\circ$ & 3713$^\circ$ & 3737$^\circ$ & 3719 \\
...
on sums vs differences it does not hurt. Removing the digest does not hurt C2 (finished mean
0.9204 against 0.9180 for the full method), removing the notebook does not either, and the single
long trajectory is strong on both. The AHC039 block, where the effect to explain is largest, is
paused at its Modal checkpoints pending the Sherlock eval servers.}
\end{figure}
...
main-campaign port). Table~\ref{tab:sel} and Figure~\ref{fig:sel} carry the snapshot.

\begin{table}[H]\centering\small
\caption{Selector study snapshot (2026-09-09 08:30 PDT; running on Sherlock, 4 of 24 arms finished).
$^\circ$ = still running.}
\label{tab:sel}
\begin{tabular}{@{}lrrrr@{}}
\toprule
...
$K{=}2$, $T{=}4$, balance & 0.9224$^\circ$ & 0.9329 & 0.9227$^\circ$ & 0.9260 \\
$K{=}2$, $T{=}4$, rpucg & 0.9154$^\circ$ & 0.9284$^\circ$ & 0.9267 & 0.9235 \\
$K{=}1$, $T{=}8$, balance & 0.9112$^\circ$ & 0.9244 & 0.9172$^\circ$ & 0.9176 \\
$K{=}1$, $T{=}8$, rpucg & 0.9066$^\circ$ & 0.9218$^\circ$ & 0.8773$^\circ$ & 0.9019 \\
port, rpucg & 0.9101 & 0.9079 & 0.9139 & 0.9106 \\
port, balance & 0.9009$^\circ$ & 0.8900$^\circ$ & 0.9378$^\circ$ & 0.9096 \\
\midrule
\multicolumn{5}{@{}l}{\textbf{sums vs differences} (higher is better)} \\
\midrule
LabNotebook $K{=}4$, $T{=}2$, balance (full) & 1.0668 & 1.0865 & 1.0621 & 1.0718 \\
$K{=}2$, $T{=}4$, balance & 1.0668$^\circ$ & 1.0922$^\circ$ & 1.0674$^\circ$ & 1.0755 \\
$K{=}2$, $T{=}4$, rpucg & 1.0633$^\circ$ & 1.0987$^\circ$ & 1.0668$^\circ$ & 1.0762 \\
$K{=}1$, $T{=}8$, balance & 1.0827 & 1.0960$^\circ$ & 1.0763$^\circ$ & 1.0850 \\
$K{=}1$, $T{=}8$, rpucg & 1.0748$^\circ$ & 1.0668$^\circ$ & 1.0621$^\circ$ & 1.0679 \\
port, rpucg & 1.0668 & 1.0677 & 1.0621 & 1.0655 \\
port, balance & 1.0757 & 1.0668$^\circ$ & 1.0773$^\circ$ & 1.0733 \\
\bottomrule
\end{tabular}
\end{table}
...
\caption{Selector study snapshot. The $K{=}2$, $T{=}4$ arms are at or above the full method on C2
under both selectors, with no separation between balance and rpucg so far; $K{=}1$, $T{=}8$ with
rpucg is the weakest cell on both tasks.}
\label{fig:sel}
\end{figure}
