...
class TemplateManager:
    ...
    def _parse_template(self, template_id: str, data: Dict[str, Any]) -> ChatroomTemplate:
    ...
    def get_template(self, template_id: str) -> Optional[ChatroomTemplate]:
        """Get template by ID"""
