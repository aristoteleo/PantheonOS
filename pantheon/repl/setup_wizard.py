...
PROVIDER_MENU = [
    ...
    ProviderMenuEntry("zai", "Z.ai (Zhipu)", "ZAI_API_KEY", "ZAI_API_BASE"),
    ProviderMenuEntry("minimax", "MiniMax", "MINIMAX_API_KEY", "MINIMAX_API_BASE"),
    ProviderMenuEntry("moonshot", "Moonshot", "MOONSHOT_API_KEY", "MOONSHOT_API_BASE"),
    ProviderMenuEntry("deepseek", "DeepSeek", "DEEPSEEK_API_KEY", "DEEPSEEK_API_BASE"),
