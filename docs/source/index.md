...
```{image} _static/pantheon.png
:alt: Pantheon Logo
:width: 120px
:align: center
```

<p style="text-align: center; font-size: 1.1rem; color: #64748b; margin: 1rem 0 1.5rem;">A framework for building distributed, evolvable multi-agent systems.</p>

:::{warning}
**Development Status**: Pantheon is currently in active development. APIs may change in future releases.
:::
...
:::{grid-item-card}
:link: getting-started/5min-tutorial
:link-type: doc
:text-align: center
